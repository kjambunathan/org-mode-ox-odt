...
Here I cite a Master Thesis \cite{zhubajie} and few books
\cite{watts_way_1999,blyth_zen_1966}.  Cite one more
reference. \cite{suzuki_studies_1998}.  Here I re-cite an earlier book
\cite{watts_way_1999}.
