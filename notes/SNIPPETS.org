...
A /near-comprehensive/ list of features that are /exclusive/ to the
/enhanced ODT exporter/.  The features listed here are not available
with the official Emacs.  You can use this /crude/ list to learn about
or explore a feature.  Each entry you see below is a commit log of the
feature, and it links to the associated commit and issues.
