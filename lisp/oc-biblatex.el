  ...
  (let ((options-no-style
         (and initial
              (let ((re (rx string-start (or "bibstyle" "citestyle" "style"))))
                (cl-remove-if
                 (lambda (option) (string-match re option))
...
ma property list."
  (apply
   ...
   (pcase style
     ...
     ;; "note" style.
     (`(,(or "note" "fn") . ,(or "bare" "b"))          '("footcitetext" t))
     (`(,(or "note" "fn") . ,_)                        '("footcite" t))
     ;; "smart" style.
     (`(,(or "smart" "sm") . ,(or "caps" "c"))         '("Smartcite" t))
     (`(,(or "smart" "sm") . ,_)                       '("smartcite" t))
     ;; "super" style.
     (`(,(or "super" "s") . ,_)                        '("supercite" t t))
     ;; "text" style.
     (`(,(or "text" "t") . ,(or "caps" "c"))           '("Textcite" t))
     (`(,(or "text" "t") . ,_)                         '("textcite" t))
     ;; "title" style.
     (`(,(or "title" "ti") . ,(or "full" "f"))         '("citetitle*"))
     (`(,(or "title" "ti") . ,_)                       '("citetitle"))
     ;; "year" style.
     (`(,(or "year" "y") . ,(or "full" "f"))           '("citeyear*"))
